...
public class FiboSample7Gen {
  ...
  private static final String FIBO_SAMPLE_RT = FiboSample7RT.class.getName().replace('.', '/');
  ...
  public static void main(String[] args) throws IOException {
    ...
    writer.visit(V1_7, ACC_PUBLIC|ACC_SUPER, "FiboSample", null, "java/lang/Object", null);
    ...
    main.visitLdcInsn(45);
    
    main.visitTryCatchBlock(start, end, handler, null);
